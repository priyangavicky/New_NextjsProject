                ...
                <div class="header-element">
                    <div class="horizontal-logo">           
                        <NuxtLink  to='/' class="header-logo">
                            ...
                            <img src="/images/brand-logos/logo.png" alt="logo" class="toggle-logo">
                            <img src="/images/brand-logos/logo.png" alt="logo" class="desktop-dark">
                            <img src="/images/brand-logos/logo.png" alt="logo" class="toggle-dark">
                            <img src="/images/brand-logos/logo.png" alt="logo" class="desktop-white">
                            <img src="/images/brand-logos/logo.png" alt="logo" class="toggle-white">
                        </NuxtLink>
                    </div>
                </div>
                <!-- End::header-element -->
            ...
            <div class="header-content-right">
                ...
                <div class="header-element country-selector">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <img src="/images/flags/Flag_of_India.png" alt="img" class="rounded-circle header-link-icon">
                        </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="/images/flags/Flag_of_India.png" alt="img">
                                    </span>
                                    India
                                </a>
                            </li>
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"  v-bind="props">
                            <div class="d-flex align-items-center">
                                <div class="me-sm-2 me-0">
                                    <img src="/images/faces/ins-pic.jpeg" alt="img" width="32" height="32" class="rounded-circle">
                                </div>
                                <div class="d-sm-block d-none">
                                    <p class="fw-semibold mb-0 lh-1">Gowtham</p>
